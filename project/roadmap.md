...
- [x] Подобрать BLDC-мотор: вес, момент (включая момент на скорости, не только stall), KV, наличие места под энкодер — критерии: [hardware.md → Motor selection criteria](../docs/hardware/hardware.md#motor-selection-criteria); кандидаты: [motor-candidates.md](../docs/hardware/motor-candidates.md) → **mjbots mj5208 + moteus r4.11 заказаны** (order MJ5921, 2026-09-05; доставка ожидается 10–11 сентября; GL40 KV70 — запасной)
